...
public class KeysVPN {
    ...
    private static final String KEYS_BASE = Paths.get("").toAbsolutePath() + "/VPNbot/out/artifacts/VPNbot_jar/Keys.txt";
    private static final String KEYS_ID = Paths.get("").toAbsolutePath() + "/VPNbot/out/artifacts/VPNbot_jar/KeysId.txt";
